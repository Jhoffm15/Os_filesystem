...
int main()
{
  ...
  int r, l1, l2, l3, f1, f2, f3, f4, f5,i;
  ...
  cout << "rv from createFile /e is " << r << (r==0?" Correct": " failure") <<endl;
  r = c1->myFS->createFile( const_cast<char *>("/E"), 2);
  cout << "rv from createFile /E is " << r << (r==0?" Correct": " failure") <<endl;
  r = c1->myFS->createFile( const_cast<char *>("/f"), 2);
  cout << "rv from createFile /f is " << r << (r==0?" Correct": " failure") <<endl;
  ...
  l3 = c1->myFS->lockFile( const_cast<char *>("/f"), 2);
  cout << "rv from lockFile /f is " << l3 << (l3>0 ? " Correct file locked": " failure") <<endl;
  ...
  r = c1->myFS->unlockFile( const_cast<char *>("/f"),2,l3);
  cout << "rv from unlockFile /f is " << r << (r==0 ? " Correct file unlocked": " failure") <<endl;
  ...
  f3 = c1->myFS->openFile( const_cast<char *>("/f"), 2, 'w', -1);
  cout << "rv from openFile /f is " << f3 << (f3>0 ? " Correct file open (w) f3": " failure") <<endl;
  ...
  cout << "rv from openFile aa is " << f5 << (f5==-4 ? " Correct file open failed invalid file name f5": " failure") <<endl;
  ...
  f5 = c1->myFS->openFile( const_cast<char *>("/A"), 2, 'r', -1);
  cout << "rv from openFile /A is " << f5 << (f5>0 ? " Correct file open (r) f5": " failure") <<endl;
  ...
  cout << "rv from closeFile f5 /A is " << r << (r==0 ? " Correct file closed f5": " failure")<<endl;
  r = c1->myFS->closeFile(f3);
  cout << "rv from closeFile f3 /f is " << r << (r==0 ? " Correct file closed": " failure")<<endl;
  ...
  f5 = c1->myFS->openFile(const_cast<char *>("/f"), 2, 'm', l3);
  cout << "rv from openFile /f is " << f5 << (f5>0 ? " Correct file opened (m) f5 ": " failure") <<endl;

  r = c1->myFS->closeFile(f1);
  cout << "rv from closeFile f1 /a is " << r << (r==0 ? " Correct file closed": " failure")<<endl;
  r = c1->myFS->closeFile(f5);
  cout << "rv from closeFile f5 /f is " << r << (r==0 ? " Correct file closed": " failure")<<endl;

  r = c1->myFS->unlockFile(const_cast<char *>("/a"),2,l2);
  cout << "rv from unlockFile /a is " << r << (r==0 ? " Correct file unlocked l2": " failure") <<endl;
  r = c1->myFS->unlockFile(const_cast<char *>("/f"),2,l3);
  cout << "rv from unlockFile /f is " << r << (r==0 ? " Correct file unlocked l3": " failure") <<endl;
